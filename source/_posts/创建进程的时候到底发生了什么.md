...
![This is a picture without description](/images/external/a590bf9e-process1.png)

如果将这些进程的父子关系组织起来，那它们应该是一个树状的结构，可以看到，所有进程都有一个公共的根进程，即pid为1的systemd：

![执行pstree命令](/images/external/6fc29d48-pstree.png)
...
![This is a picture without description](/images/external/aa024bfe-systemd.png)
